...
export const PACKAGE_PRICING = {
  ...
  '5': { 
    ...
    couponCode: 'HELLOBIT', 
    couponDiscount: 20,
    secretCouponCode: 'ARYAN',       // SECRET coupon
    secretCouponDiscount: 59        // 79 - 59 = 20
  }
};
...
export const validateCouponForPackage = (packageType, couponCode) => {
  ...
  // Check normal coupon
  if (appliedCoupon === packageInfo.couponCode) return true;

  // Check secret coupon
  if (appliedCoupon === packageInfo.secretCouponCode) return true;
